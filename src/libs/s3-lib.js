...
class S3Lib {
   ...
   * @param {string} payload.destFilePath
   * @description Upload file to s3.
   */
  static async uploadFileToS3 (payload) {
    const { bucket, key, secret, fileBuffer, fileMimeType, destFilePath } = payload;
